...
var toads = __webpack_require__(2);
var changeToads = __webpack_require__(18);
var winLogic = __webpack_require__(19);
...
var placePiece = $('.game-board-square').on('click', function () {
...
module.exports = __webpack_require__.p + "bd56c3385aaf55606edac34b5bd5c976.jpg";
...
var placePiece = __webpack_require__(1);
...
var onMakeMove = function onMakeMove(event) {
  event.preventDefault();
  var data = placePiece.gameValues;
  api.makeMove(data.i, data.v, data.isOver).then(ui.makeMoveSuccess).catch(ui.fail);
};
...
var makeMove = function makeMove(index, value, over) {
  return $.ajax({
    method: 'PATCH',
...
var makeMoveSuccess = function makeMoveSuccess() {
...
var changeToads = function changeToads() {
...
var updateWins = __webpack_require__(20);

var winConditions = [[0, 1, 2], [0, 3, 6], [0, 4, 8], [1, 4, 7], [2, 4, 6], [2, 5, 8], [3, 4, 5], [6, 7, 8]];

var compareArrays = function compareArrays(array, array2d) {
...
var checkWin = function checkWin(toadParam, callback) {
  toadParam.placements.sort();
  for (var i = 0; i < toadParam.placements.length; i++) {
...
var updateWins = function updateWins(toadWinner) {
